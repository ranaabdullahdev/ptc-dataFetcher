...
import { Search, Loader2, QrCode, Database, Smartphone, FileSpreadsheet } from "lucide-react"
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium mb-6">
            ...
            Real-time Google Sheets Data & Excel Analytics
          </div>
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Search Google Sheets data, import from URLs, or upload Excel files for instant analysis and visualization
          </p>
        </div>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">File & URL Import</h3>
            <p className="text-gray-600">Upload Excel files or import Google Sheets via URL for analysis</p>
          </div>
          <div className="text-center">
      ...
      <footer className="border-t bg-white/80 backdrop-blur-sm mt-16">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center text-gray-600">
            <p>&copy; 2024 Data Fetcher. Real-time data at your fingertips.</p>
          </div>
        </div>
      </footer>
    </div>
